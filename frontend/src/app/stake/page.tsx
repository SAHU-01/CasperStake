...
//                 {/* 14-hour Warning - Important but compact */}
...
//                       <p><span className="text-white">Request unstake</span> — Burns your csCSPR and starts the 14-hour unbonding period</p>
//                     </div>
//                     <div className="flex gap-3">
//                       <div className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center text-xs text-gray-400 flex-shrink-0">⏳</div>
//                       <p><span className="text-white">14-hour waiting</span> — Required by Casper network for security. You stop earning rewards.</p>
//                     </div>
//                     <div className="flex gap-3">
...
const CONTRACTS = {
  CASPER_STAKE: "hash-9e4048c568d6a47520d1e53f5d98ca83d3bfefcbabfa138b9863d212038ecea6",
};
